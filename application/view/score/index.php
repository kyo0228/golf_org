          <div class="row">
            <div class="container-fluid">
              ...
              <?php
              if (!$this->value("group_data", "group_id") === "1") {
                ?>
                  ...
                  <div class="card-body">
                    <div id="typography">
                      <div class="row">
                        <div class="info_row">
                          <img class="info_img" src="<?= $this->url_images("faces/ball.jpeg") ?>">
                          <span class="info_msg">ゴルフコンペスコア管理へようこそ。コンペ参加者の登録やゴルフコースの設定、スコア登録は管理者権限を持っている人が行います。メンバー権限の人はデータ登録できません。</span>
                        </div>
